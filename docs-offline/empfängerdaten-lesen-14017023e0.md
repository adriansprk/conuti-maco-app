...
info:
  ...
  version: 1.0.0
paths:
  /lesenMarktteilnehmerEmpfaenger:
    get:
      summary: Empfängerdaten lesen
      deprecated: true
      description: >-
        ** OBSOLET: Daten sind bereits im Event Container vorhanden **

        Lesen einen recipient(marktteilnehmer) mit LokationsId  (Parameter1) 
        zum Zeitpunkt (Parameter2) | Read a recipient (market participant)
      ...
      parameters:
        - name: command
          ...
          schema:
            ...
            type: string
            examples:
              - SAP_LESEN_MARKTTEILNEHMER_EMPFAENGER
        - name: parameter1
          in: query
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/816353/apis/api-14017023-run
components:
  schemas: {}
  securitySchemes:
    bearer:
