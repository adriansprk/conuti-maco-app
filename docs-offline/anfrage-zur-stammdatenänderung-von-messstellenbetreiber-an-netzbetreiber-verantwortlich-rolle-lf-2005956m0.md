# Anfrage zur Stammdatenänderung von Messstellenbetreiber an Netzbetreiber (verantwortlich) (Rolle LF)


![LW24h mit Abhängigkeiten - GAS Anfrage zur Stammdatenänderung von Messstellenbetreiber an Netzbetreiber (verantwortlich) (Rolle LF).png](https://api.apidog.com/api/v1/projects/816353/resources/373053/image-preview)
<Steps>
