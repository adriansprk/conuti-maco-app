...
info:
  ...
  version: 1.0.0
paths:
  /getMeasuringPointOperationContractBasic:
    get:
      summary: Messstellenbetriebsvertrag lesen
      deprecated: false
      description: >+
        Lesen des Messstellenbetriebsvertrages einer Lokation (Parameter1) vom
        Typ (Parameter2 - default MALO) zum Stichtag (Parameter3)
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/816353/apis/api-14017025-run
components:
  schemas:
    Vertrag:
      title: Vertrag
