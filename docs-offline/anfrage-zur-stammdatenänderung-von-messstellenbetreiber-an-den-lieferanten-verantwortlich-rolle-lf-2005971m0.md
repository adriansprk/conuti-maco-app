# Anfrage zur Stammdatenänderung von Messstellenbetreiber an den Lieferanten (verantwortlich) (Rolle LF)


![LW24h mit Abhängigkeiten - GAS Anfrage zur Stammdatenänderung von Messstellenbetreiber an den Lieferanten (verantwortlich) (Rolle LF).png](https://api.apidog.com/api/v1/projects/816353/resources/373054/image-preview)
<Steps>
