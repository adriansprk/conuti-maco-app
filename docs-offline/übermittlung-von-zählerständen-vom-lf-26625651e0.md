# Übermittlung von Zählerständen vom LF
...
paths:
  /inbound:
    post:
      summary: Übermittlung von Zählerständen vom LF
      deprecated: false
      description: Übermittlung von Zählerständen vom LF
      operationId: Übermittlung von Zählerständen vom LF
      tags:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/816353/apis/api-26625651-run
components:
  schemas:
