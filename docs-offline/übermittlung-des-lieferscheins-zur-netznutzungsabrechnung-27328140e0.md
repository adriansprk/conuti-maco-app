# Übermittlung des Lieferscheins zur Netznutzungsabrechnung
...
paths:
  /inbound:
    post:
      summary: Übermittlung des Lieferscheins zur Netznutzungsabrechnung
      deprecated: false
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/816353/apis/api-27328140-run
components:
  schemas:
