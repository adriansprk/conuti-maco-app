...
paths:
  /inbound:
    post:
      summary: Identifikation einer Marktlokation
      deprecated: false
      description: >-
        Prozess zur Identifikation einer Marktlokation beim Netzbetreiber
        anstoßen.
      operationId: START_MALOIDENT
      tags:
        - Schnittstellen/MaloIdent LF (Backend)
        - TRIGGER
      parameters: []
      requestBody:
        content:
      ...
      security:
        - bearer: []
      x-apidog-folder: Schnittstellen/MaloIdent LF (Backend)
      x-apidog-status: released
      x-run-in-apidog: https://app.apidog.com/web/project/816353/apis/api-16024919-run
components:
  schemas:
    '[LF] START_MALOIDENT':
      type: object
