...
info:
  ...
  version: 1.0.0
paths:
  /getEnergyAmountMeterReading:
    get:
      summary: Zählerstand einer Lokation lesen
      deprecated: false
      description: >-
        Lesen eines oder mehrerer Zählerstände über eine Lokation (Parameter1)
        in einer Range (Parameter2/Parameter3) und einer OBIS Kennzahl
        (Parameter4 optional) 
      ...
      responses:
        '200':
          description: >-
            Erfolgreiches Lesen der Zählerstände | Successful reading of the
            meter readings
          content:
            application/json:
              schema:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/816353/apis/api-14017017-run
components:
  schemas:
    Energiemenge:
      title: Energiemenge
