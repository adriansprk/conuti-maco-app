...
paths:
  /getEnergyAmount:
    get:
      summary: Energiemengen aus Abrechnungskontext  lesen
      deprecated: false
      description: >-
        Lesen der Energiemengen aus Abrechnungskontext über eine LokationId
        (Parameter1) und LokationsTyp (Parameter2) in einer Range
        (Parameter3/Parameter4) und einer OBIS Kennzahl (Parameter5 optional)
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/816353/apis/api-14017015-run
components:
  schemas:
    Energiemenge:
      title: Energiemenge
