...
![LW24h mit Abhängigkeiten - Storno (alle Rollen)(1).png](https://api.apidog.com/api/v1/projects/816353/resources/367044/image-preview)
...
<Steps>
  <Step title="Prozessauslöser - Event" defaultOpen={false}>
    <Tabs>
      ...
      <Tab title="📄55022 Anfrage nach Stornierung starten">
  ...
  <Step title="Prozessinitiierung Backend">
    ...
    <Tabs>
      <Tab title="Übersicht">
          <Card title="Aktualisieren der Prozessdaten"
                href="https://doc.macoapp.de/prozessdaten-aktualiseren-14017182e0.md">
              Übergabe der pos. sowie neg. Rückmeldung vom Beteiligte aus Ursprungsnachricht.
          </Card>    
      </Tab>        
      <Tab title="📄55023 neg. Rückmeldung">
      ...
      <Tab title="📄55024 pos. Rückmeldung">
