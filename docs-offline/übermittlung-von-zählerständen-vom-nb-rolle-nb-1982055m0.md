...
![LW24h mit Abhängigkeiten - Übermittlung von  Zählerständen vom LF (Rolle MSB).png](https://api.apidog.com/api/v1/projects/816353/resources/372795/image-preview)
...
<Steps>
  ...
  <Step title="Prozessinitiierung Backend">
    <Tabs>
      ...
      <Tab title="13017 - Zählerstand vom LF (Strom)">
          <Accordion title="PI_13017" defaultOpen={false}>
                     <DataSchema id="12586651" />
          </Accordion>
       </Tab> 
