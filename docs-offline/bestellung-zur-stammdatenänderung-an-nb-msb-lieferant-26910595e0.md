# Bestellung zur Stammdatenänderung an NB / MSB (Lieferant)
...
paths:
  /inbound:
    post:
      summary: Bestellung zur Stammdatenänderung an NB / MSB (Lieferant)
      deprecated: false
      description: >-
        ...
        werden kann.
      operationId: START_BESTELLUNG_SDAE
      tags:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/816353/apis/api-26910595-run
components:
  schemas:
