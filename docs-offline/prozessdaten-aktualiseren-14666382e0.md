    ...
    post:
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/Prozessdaten%20aktualiseren%20NB'
            example: ''
      responses:
        '200':
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/816353/apis/api-14666382-run
components:
  schemas:
    Prozessdaten aktualiseren NB:
      allOf:
        - anyOf:
            ...
            - $ref: '#/components/schemas/PI_55227'
            - $ref: '#/components/schemas/PI_55180'
            - $ref: '#/components/schemas/PI_55177'
            - $ref: '#/components/schemas/PI_25010'
            - $ref: '#/components/schemas/PI_55614'
            - $ref: '#/components/schemas/PI_55673'
            - $ref: '#/components/schemas/PI_55692'
            - $ref: '#/components/schemas/PI_55036'
            - $ref: >-
                #/components/schemas/44014_Meldung_des_EG_ob_und_ggf_f%C3%BCr_welchen_Zeitraum_die_Marktlokation_der_Ersatzversorgung_oder_Grundversorgung_zuzuordnen_ist
            - $ref: >-
                #/components/schemas/44015_Meldung_des_EG_ob_und_ggf_f%C3%BCr_welchen_Zeitraum_die_Marktlokation_ihm_nicht_zuzuordnen_ist
    ...
    ZUSATZDATEN ( SST Aktualisieren):
      ...
      x-apidog-ignore-properties: []
      x-apidog-folder: ''
    44015_Meldung_des_EG_ob_und_ggf_für_welchen_Zeitraum_die_Marktlokation_ihm_nicht_zuzuordnen_ist:
      type: object
      properties:
        transaktionsdaten:
          type: object
      ...
      required:
        ...
        - stammdaten
      description: >-
        44015 - Meldung des E/G, ob und ggf. für welchen Zeitraum die
        Marktlokation ihm nicht zuzuordnen ist. [E/G an NB] UTILMD AHB Gas
      x-apidog-orders:
        - transaktionsdaten
        - stammdaten
      x-apidog-ignore-properties: []
      x-apidog-folder: ''
    44014_Meldung_des_EG_ob_und_ggf_für_welchen_Zeitraum_die_Marktlokation_der_Ersatzversorgung_oder_Grundversorgung_zuzuordnen_ist:
      type: object
      properties:
        stammdaten:
          type: object
      ...
      required:
        ...
        - transaktionsdaten
      description: >-
        44014 - Meldung des E/G, ob und ggf. für welchen Zeitraum die
        Marktlokation der Ersatzversorgung oder Grundversorgung zuzuordnen ist.
        [E/G an NB] UTILMD AHB Gas
      x-apidog-orders:
        - stammdaten
        - transaktionsdaten
      x-apidog-ignore-properties: []
    ...
    PI_55036:
      ...
      required:
        - transaktionsdaten
        - stammdaten
      description: 55036 - NB an LFN - Information über existierende Zuordnung
      x-apidog-orders:
        - transaktionsdaten
        - stammdaten
      x-apidog-ignore-properties: []
    ...
    PI_55692:
              ...
              items:
                ...
                properties:
                  paketId:
                    ...
                    description: >-
                      paketId | EDIFACT:
                      SG4.IDE+24.SG8.SEQ+[Z80|Z81].SG10.CCI+Z67
                  marktlokationsId:
                    type: string
                    description: >-
                      Die ID der Marktlokation der der zu sperrende Zähler
      ...
      required:
        ...
        - transaktionsdaten
      description: >-
        55692 - ÜNB an NB - Bestellung einer Änderung von Stammdaten vom ÜNB an
        NB
      x-apidog-orders:
        - stammdaten
        - transaktionsdaten
    ...
    PI_55673:
                    ...
                    properties:
                      einheit:
                        ...
                        description: >-
                          ...
                          SG4.IDE+24.SG8.SEQ+[Z80|Z81].SG9.QTY+[Z10|265]
                        enum:
                          - W
                          - WH
                          - KW
              ...
              items:
                ...
                properties:
                  ...
                  bilanzkreis:
                    type: object
                    title: Bilanzkreis
                    description: 'EDIFACT: SG4.IDE+24.SG8.SEQ+[Z94|Z95].SG10.CCI+Z19'
                    x-apidog-orders: []
                    properties: {}
                    x-apidog-ignore-properties: []
                x-apidog-orders:
      ...
      required:
        - stammdaten
        - transaktionsdaten
      description: 55673 - LF an NB - Bestellung einer Änderung von Abrechnungsdaten
      x-apidog-orders:
        - stammdaten
        - transaktionsdaten
      x-apidog-ignore-properties: []
    ...
    PI_55614:
              ...
              items:
                ...
                properties:
                  ...
                  prognosegrundlage:
                    ...
                    description: >-
                      Prognosegrundlage | EDIFACT:
                      SG4.IDE+24.SG8.SEQ+[Z80|Z81].SG10.CCI+[ZC0|ZA6]
                    enum:
                      - WERTE
                      - PROFILE
                  bilanzkreis:
                  ...
                  detailsPrognosegrundlage:
                    ...
                    items:
                      ...
                      description: >-
                        ...
                        Wiederholung des CAV Segments mit der Angabe der Codes
                        E02 und E14 möglich. | EDIFACT:
                        SG4.IDE+24.SG8.SEQ+[Z80|Z81].SG10.CCI+[ZC0|ZA6].CAV+E02
                      items:
                        type: string
                        title: Profiltyp
                        description: Profiltyp
      ...
      required:
        ...
        - stammdaten
      description: >-
        55614 - ÜNB an NB - Bestellung einer Änderung von Abrechnungsdaten zur
    ...
    PI_25010:
              ...
              items:
                ...
                properties:
                  zeitraumId:
                    type: integer
                    description: >-
                      zeitraumId | EDIFACT: SG5.IDE+24.STS+E01,
                      SG5.IDE+24.FTX+ACB
                  freitext:
                    type: object
                    title: Freitext
                    description: 'EDIFACT: SG5.IDE+24.FTX+ACB'
                    x-apidog-orders: []
                    properties: {}
                    x-apidog-ignore-properties: []
                  liste:
                    type: string
                    description: 'liste | EDIFACT: SG5.IDE+24.STS+E01'
                  code:
                    type: object
                    title: Objectcode
                    description: 'EDIFACT: SG5.IDE+24.STS+E01'
                    x-apidog-orders: []
                    properties: {}
                    x-apidog-ignore-properties: []
                x-apidog-orders:
      ...
      required:
        - transaktionsdaten
      description: >-
        25010 - MSB (entspricht dem MSB am Objekt Messlokation) an NB - Antwort
        auf Berechnungsformel
      x-apidog-orders:
        - transaktionsdaten
      x-apidog-ignore-properties: []
      x-apidog-folder: ''
    ...
    PI_55227:
                      ...
                      properties:
                        artikelId:
                          ...
                          description: >-
                            ...
                            SG4.IDE+24.SG8.SEQ+[ZH1|ZH2].PIA+Z02
                          items:
                            type: string
                        zahlerBlindarbeit:
                          type: string
                          ...
                          description: >-
                            ...
                            SG4.IDE+24.SG8.SEQ+[ZH1|ZH2].SG10.CCI+Z45.CAV+ZE4
                          enum:
                            - ANSCHLUSSNUTZER
                            - LIEFERANT
                            - NICHT_FESTGELEGT
                        ...
                        abrechnungBlindarbeit:
                          ...
                          description: >-
                            ...
                            SG4.IDE+24.SG8.SEQ+[ZH1|ZH2].SG10.CCI+Z45
                      x-apidog-orders:
                        - artikelId
                        - zahlerBlindarbeit
                        - artikelIdTyp
      ...
      required:
        - transaktionsdaten
        - stammdaten
      description: "55227 - LF an NB - Bestellung einer Änderung von Stammdaten vom \_LF an NB"
      x-apidog-orders:
        - transaktionsdaten
        - stammdaten
      x-apidog-ignore-properties: []
